...
export type GetGraphsQuery = {
  __typename?: "Query";
  graphs: Array<{ __typename?: "Graph"; uuid: any; name: string }>;
};
...
export type CreateScriptCellMutation = {
  __typename?: "Mutation";
  addScriptCell: {
    __typename?: "ScriptCell";
    cellOrder: number;
...
export type DeleteScriptCellMutation = {
  __typename?: "Mutation";
  deleteScriptCell?: any | null;
};
...
export type UpdateScriptCellsMutation = {
  __typename?: "Mutation";
  updateScriptCells?: any | null;
};

export type CountSubscriptionSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type CountSubscriptionSubscription = {
  __typename?: "Subscription";
  count: number;
};
...
export type GraphSubscription = {
  ...
  graph: {
    ...
    edges: Array<{
      __typename?: "Edge";
      uuid: any;
      outNode: { __typename?: "Node"; uuid: any };
      inNode: { __typename?: "Node"; uuid: any };
    }>;
    nodes: Array<{
      __typename?: "Node";
      name: string;
...
export type StreamSubscription = {
  __typename?: "Subscription";
  streamInfo:
    | { __typename: "NoStreamAvailableError"; error: string }
    | {
        __typename: "StreamInfo";
        stream: {
          __typename?: "Stream";
...
export function useCreateScriptCellMutation() {
  return Urql.useMutation<
    CreateScriptCellMutation,
    CreateScriptCellMutationVariables
  >(CreateScriptCellDocument);
}
...
export function useCountSubscriptionSubscription<
  R = CountSubscriptionSubscription
>(
  options: Omit<
    Urql.UseSubscriptionArgs<never, CountSubscriptionSubscriptionVariables>,
    "query"
  > = {},
  handler?: Urql.SubscriptionHandlerArg<CountSubscriptionSubscription, R>,
) {
  return Urql.useSubscription<
    CountSubscriptionSubscription,
    R,
    CountSubscriptionSubscriptionVariables
  >({ query: CountSubscriptionDocument, ...options }, handler);
}
