...
export interface NodeSubscription { node: { color: string; name: string; positionX: number; positionY: number; uuid: any; scriptCells: Array<{ cellCode: string; cellOrder: number; cellType: CellType; uuid: any; audioCell?: { playback: PlaybackChoices; uuid: any; audioFile: { uuid: any; name: string; autoGenerated: boolean; description: string; file?: { url: string; name: string } | null } } | null }> } }
