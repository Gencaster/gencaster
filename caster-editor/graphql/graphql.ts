...
export type MyQueryQuery = {
  __typename?: 'Query';
  graphs: Array<{ __typename?: 'Graph'; name: string }>;
};
...
export type TestQueryQuery = {
  ...
  graphs: Array<{
    __typename?: 'Graph';
    name: string;
    nodes: Array<{ __typename?: 'Node'; name: string }>;
    edges: Array<{ __typename?: 'Edge'; uuid: any }>;
  }>;
};
...
export function useMyQueryQuery(
  options: Omit<Urql.UseQueryArgs<never, MyQueryQueryVariables>, 'query'> = {}
) {
...
export function useTestQueryQuery(
  options: Omit<Urql.UseQueryArgs<never, TestQueryQueryVariables>, 'query'> = {}
) {
