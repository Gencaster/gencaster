...
const debugBlockData: ScriptCell[] = [
  // Markdown
  { node: emptyNode, cellCode: "<h2> Hello Markdown</h2> <p> this is a markdown cell.</p>", cellOrder: 0, cellType: "markdown", uuid: "51d31f9d-a94d-4edf-9aaf-105267b50130", __typename: "ScriptCell" },
